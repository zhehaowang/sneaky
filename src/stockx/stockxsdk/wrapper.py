...
class Stockx():
    ...
    def __init__(self):
        ...
        self.cookies = {
            ...
            "_tl_uid": "b2972445-8e58-11e9-8880-12deb909e97c",
            "ajs_user_id": "%22b2972445-8e58-11e9-8880-12deb909e97c%22",
            "ajs_anonymous_id": "%228675def0-03a8-4fbc-8142-40f3f3602e48%22",
            "_pxvid": "04c25671-8417-11e9-b057-edcb5fe9ed72",
            "stockx_default_sneakers_size": "7.5",
            "_sp_ses.1a3e": "*",
            "_tl_csid": "0f785caa-0732-4804-86b6-3dc1cb1d1157",
            "_pk_ref.421.1a3e": "%5B%22%22%2C%22%22%2C1560491268%2C%22https%3A%2F%2Fwww.google.com%2F%22%5D",
            "_pk_ses.421.1a3e": "*",
            "_tl_auid": "5d031b72fee7dd00190f2214",
            "_tl_sid": "5d033505478ca5000fe66f11",
            "stockx_session": "2rm8rw7jwvp3kz61560492761586",
            "_pk_id.421.1a3e": "0102423b573ff79c.1559356551.14.1560492779.1560491267.",
            "tl_sopts_0f785caa-0732-4804-86b6-3dc1cb1d1157_p_p_n": "JTJGbG9naW4",
            "tl_sopts_0f785caa-0732-4804-86b6-3dc1cb1d1157_p_p_l_h": "aHR0cHMlM0ElMkYlMkZzdG9ja3guY29tJTJGbG9naW4",
            "tl_sopts_0f785caa-0732-4804-86b6-3dc1cb1d1157_p_p_l_t": "U3RvY2tYJTNBJTIwQnV5JTIwYW5kJTIwU2VsbCUyMFNuZWFrZXJzJTJDJTIwU3RyZWV0d2VhciUyQyUyMEhhbmRiYWdzJTJDJTIwV2F0Y2hlcw",
            "tl_sopts_0f785caa-0732-4804-86b6-3dc1cb1d1157_p_p_l": "",
            "tl_sopts_0f785caa-0732-4804-86b6-3dc1cb1d1157_p_p_v_d": "MjAxOS0wNi0xNFQwNiUzQTEyJTNBNTguNzA1Wg",
            "is_gdpr": "false",
            "stockx_selected_currency": "USD",
            "stockx_selected_locale": "en_US",
            "IR_9060": "1560492779166%7C0%7C1560491270073%7C%7C",
            "IR_PI": "e9ea8dde-4f7d-11e9-a97b-12cd5acec8a1%7C1560579179166",
            "show_all_as_number": "false",
            "brand_tiles_version": "v1",
            "show_bid_education": "v5",
            "show_bid_education_times": "1",
            "mobile_nav_v2": "true",
            "multi_edit_option": "beatLowestAskBy",
            "product_page_v2": "watches%2Chandbags",
            "show_watch_modal": "true",
            "_derived_epik": "dj0yJnU9eS05c2RnUy1FMHFHMGVWMXZrR0NPMzVmMGlfNWR4UTQmbj0xUGtfY0k5X2RDWHpORjdncmJKVVhRJm09MSZ0PUFBQUFBRjBET3Vz",
            "lastRskxRun": "1560492779751",
            "cookie_policy_accepted": "true",
            "_sp_id.1a3e": "1e9c87cf-e416-485c-8050-e01d906c916d.1559356549.15.1560492828.1560488709.cc2e0f25-cbb9-4633-882b-1a57000a53a3",
    ...
    def __api_query(self, request_type, command, data=None):
        ...
        if response.status_code == 200:
            ...
            print("response: {}. we give up on this api query.".format(response))
            return {}
